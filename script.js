...
var whatsappLink = 'https://wa.me/+916382767198?text='
whatsappLink += "Order Details"+" "
function WhatsappText(){
for(let j=0; j < items.length; j++){
  if(items[j].quantity!=0){
  whatsappLink += items[j].name+ " "+items[j].quantity+" ";}
}
whatsappLink+="$"+finalDollars+"."+finalCents+"cents"
}
